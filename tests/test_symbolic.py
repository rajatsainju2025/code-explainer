...
from code_explainer.symbolic import SymbolicAnalyzer, format_symbolic_explanation
...
"""
        ...
        sorting_test_found = any(
            "sort" in desc.lower() or "permutation" in desc.lower()
...
"""
        ...
        assert (
            "## Code Explanation" in symbolic_explanation
            or "## Symbolic Analysis" in symbolic_explanation
        )

    @pytest.mark.parametrize(
        "strategy", ["vanilla", "ast_augmented", "retrieval_augmented", "execution_trace"]
    )
...
"""
        ...
        explanation = explainer.explain_code_with_symbolic(
            code, include_symbolic=True, strategy=strategy
        )
