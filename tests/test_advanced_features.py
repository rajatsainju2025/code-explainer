...
from code_explainer.config_validator import ConfigValidator
from code_explainer.profiler import PerformanceProfiler
from code_explainer.quality_analyzer import CodeQualityAnalyzer, IssueLevel
...
class TestConfigValidator:
    ...
    def test_valid_config(self, tmp_path):
        ...
        config = {"model": {"name": "test-model"}, "prompting": {"strategy": "vanilla"}}
    ...
    def test_invalid_strategy(self):
        ...
        config = {"model": {"name": "test-model"}, "prompting": {"strategy": "invalid_strategy"}}
...
"""
        ...
        complexity_issues = [
            i
            for i in issues
            if i.rule_id and ("complexity" in i.rule_id or "arguments" in i.rule_id)
        ]
...
"""
        ...
        practice_issues = [
            i for i in issues if i.rule_id in ["mutable_default", "old_string_formatting"]
        ]
...
class TestPerformanceProfiler:
    ...
    def test_benchmark_operation(self):
        ...
        results = profiler.benchmark_operation(
            simple_operation, "simple_sum", num_iterations=3, n=50
        )
