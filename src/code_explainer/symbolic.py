...
class SymbolicAnalyzer:
    ...
    def _analyze_complexity(self, tree: ast.AST) -> Dict[str, Any]:
        ...
        complexity: Dict[str, Any] = {
            ...
            'number_of_loops': len([n for n in ast.walk(tree) if isinstance(n, (ast.For, ast.While))]),
    ...
    def _extract_condition_from_if(self, node: ast.If, condition_type: str) -> Optional[SymbolicCondition]:
    ...
    def _extract_condition_from_assert(self, node: ast.Assert, condition_type: str) -> Optional[SymbolicCondition]:
    ...
    def _generate_function_property_tests(self, node: ast.FunctionDef, code: str) -> List[PropertyTest]:
