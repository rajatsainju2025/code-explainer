    ...
    SECTION_SCHEMAS = {
        ...
        "training": {
            ...
            "optional": [
                ...
                "gradient_accumulation_steps", "learning_rate", "weight_decay", "logging_steps",
                "evaluation_strategy", "eval_steps", "save_steps", "save_total_limit",
                "load_best_model_at_end", "metric_for_best_model", "greater_is_better",
                "warmup_steps", "fp16", "dataloader_num_workers", "remove_unused_columns"
            ]
        },
        "data": {
            "required": [],
        ...
        "generation": {
            "required": [],
            "optional": [
                "max_new_tokens", "num_beams", "do_sample", "temperature", "top_p", "pad_token_id"
            ]
        },
        "prompting": {
            "required": ["strategy"],
        ...
        "retrieval": {
            "required": [],
            "optional": [
                "index_path", "embedding_model", "index_dimension", "similarity_top_k",
                "similarity_threshold", "chunk_size", "chunk_overlap"
            ]
        },
        "multi_agent": {
            "required": [],
            "optional": ["enabled", "agents"]
        },
        "symbolic": {
            "required": [],
            "optional": [
                "enabled", "max_execution_time", "include_complexity", 
                "include_dataflow", "generate_tests"
            ]
        },
        "evaluation": {
            "required": [],
            "optional": ["metrics", "batch_size", "max_samples"]
        },
        "logging": {
            "required": [],
            "optional": ["level", "format", "file"]
        },
        "web": {
            "required": [],
            "optional": ["gradio", "api"]
    ...
    def _validate_section(self, section_name: str, section_config: Any) -> None:
        ...
        for required_field in schema["required"]:
            if required_field not in section_config:
                self.errors.append(f"Required field '{required_field}' missing in section '{section_name}'")
